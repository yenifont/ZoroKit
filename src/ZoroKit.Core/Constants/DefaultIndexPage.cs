namespace ZoroKit.Core.Constants;
...
public static class DefaultIndexPage
{
    public const string Content = """
        ...
        <title>ZoroKit - Local Development Environment</title>
        <style>
        ...
        <div class="wrapper">
          ...
          <div class="section">
            ...
            <div class="links">
              ...
              <a href="https://github.com/ZoroKit" class="link-card" target="_blank" rel="noopener">
          ...
          <div class="footer">
            <p><span class="heart">&hearts;</span> <strong>ZoroKit</strong> &mdash; Apache, PHP ve MariaDB yerel gelistirme ortami</p>
