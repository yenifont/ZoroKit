...
public sealed class OrchestratorService
{
    ...
    public async Task InitializeAsync(CancellationToken ct = default)
    {
        ...
        // İlk kurulumda varsayılan zorokit.app hosts + vhost (ana www açılır)
        try { await _autoVHostManager.EnsureDefaultZoroKitHostAsync(ct); }
        ...
        await Task.WhenAll(
            ...
            _logWatcher.StartWatchingAsync(appLog, "ZoroKit", ct));
