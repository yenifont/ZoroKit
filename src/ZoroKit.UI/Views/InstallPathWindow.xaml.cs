...
{
    public string SelectedPath { get; private set; } = @"C:\ZoroKit";
    ...
    private void BrowseButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            Description = "ZoroKit kurulum dizinini seçin",
    ...
    private void StartButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            ShowError("Lütfen geçerli bir tam dizin yolu girin. Örn: C:\\ZoroKit");
            return;
        }
        ...
        try
        {
            ...
            var testFile = Path.Combine(fullPath, ".ZoroKit_write_test");
